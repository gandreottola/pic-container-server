...
router.get('/albums', requireToken, (req, res, next) => {
  Album.find()
    .then(Albums => {
      ...
      return Albums.map(example => example.toObject())
    })
...
// SHOW
// GET /albums/5a7db6c74d55bc51bdf39793
...
router.post('/albums', requireToken, (req, res, next) => {
  // set owner of new album to be current user
...
// DESTROY
// DELETE /albums/5a7db6c74d55bc51bdf39793
